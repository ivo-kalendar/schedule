...
export const CLEAR_EDIT_TABLE = 'CLEAR_EDIT_TABLE';
export const PUT_DISTRIBUTOR_VALUES = 'PUT_DISTRIBUTOR_VALUES';
export const GET_HOUR_OPTIONS = 'GET_HOUR_OPTIONS';
